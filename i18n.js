...
(function (w) {
  ...
  const D = {
    ...
    sub_ok:        { uz: 'Rahmat! Siz obuna bo\u2018ldingiz.', ru: 'Спасибо! Вы подписались.', en: 'Thank you! You are subscribed.' },
    sub_later:     { uz: 'Keyinroq', ru: 'Позже', en: 'Later' },
    sub_ok_text:   { uz: 'Yangi tahlil va nashrlar e-pochtangizga keladi.', ru: 'Новая аналитика и публикации будут приходить на вашу почту.', en: 'New analysis and publications will arrive in your inbox.' },
    ...
    sub_privacy:   { uz: 'Obuna bo‘lish orqali shaxsiy ma’lumotlaringizni qayta ishlashga rozilik bildirasiz.', ru: 'Подписываясь, вы соглашаетесь на обработку персональных данных.', en: 'By subscribing, you agree to the processing of your personal data.' },
